...
| 3 | Cross-Role Real-Time Monotonic Pipeline Parity | outbox/relay.go, ws/hub.go, warehouse/service.go, rebate/service.go, consignment/service.go, matching/service.go, warehouse-desktop/lib/fleet-ws-events.ts, supplier-desktop | M1 | DONE |
| 4 | Comprehensive Automated Test Suite & Race Verification | go test -v -race ./... across all backend packages & scale benchmarks | M1, M2, M3 | DONE |
