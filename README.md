...
### Native Desktop Targets (Web Roles)

- Supplier/Admin desktop: `cd the-lab-monorepo/apps/admin-portal && npm run tauri:dev`
- Factory admin desktop: `cd the-lab-monorepo/apps/factory-portal && npm run tauri:dev`
- Warehouse admin desktop: `cd the-lab-monorepo/apps/warehouse-portal && npm run tauri:dev`
- Retailer desktop: `cd the-lab-monorepo/apps/retailer-app-desktop && npm run tauri:dev`
