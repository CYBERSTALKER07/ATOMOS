...
- Factory role-row route composition: `pegasus/apps/backend-go/factoryroutes/routes.go`
	...
	- Factory live-update policy is currently polling-based: portal + Android + iOS dashboards refresh every 30 seconds; there is no mounted `/v1/ws/factory` realtime route
