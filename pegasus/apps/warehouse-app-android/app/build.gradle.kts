...
val generatedWsModelFile = rootProject.file(
    "app/src/main/java/com/pegasus/warehouse/generated/contracts/PegasusWSEventEnvelope.kt"
)
...
val generateWsEventModels by tasks.registering(Exec::class) {
    ...
    commandLine(
        ...
        contractsSchemaFile.absolutePath,
        "--package",
        "com.pegasus.warehouse.generated.contracts",
        "--framework",
        "kotlinx",
        "--top-level",
...
android {
    ...
    defaultConfig {
        applicationId = "com.pegasus.warehouse"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
