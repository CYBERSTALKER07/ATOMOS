...
|---------|----------|-----------|----------|--------|---------|---------|
| Pulse timeline | portal dashboard | portal dashboard | desktop tracking (optional) | Android home strip (iOS deferred) | Android home strip (iOS deferred) | portal dashboard |
