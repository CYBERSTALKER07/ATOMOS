...
| Handoff timeline | dispatch page | `DispatchScreen` | `DispatchView` | `GET /v1/warehouse/ops/pulse` (filtered) | Preorder → seal chain | Wired — PX-ECS-4E |
