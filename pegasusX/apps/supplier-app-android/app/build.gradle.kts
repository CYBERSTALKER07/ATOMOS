...
val generatedWsModelFile = rootProject.file(
    "app/src/main/java/com/pegasusx/supplier/generated/contracts/PegasusWSEventEnvelope.kt"
)
val wsCodegenEnabled = localProps.getProperty("supplier.ws.codegen", "false") == "true"
...
val generateWsEventModels by tasks.registering(Exec::class) {
    ...
    commandLine(
        ...
        contractsSchemaFile.absolutePath,
        "--package",
        "com.pegasusx.supplier.generated.contracts",
        "--framework",
        "kotlinx",
        "--top-level",
