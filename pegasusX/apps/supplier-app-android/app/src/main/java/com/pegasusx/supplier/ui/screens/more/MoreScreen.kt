...
fun MoreScreen(
    ...
    val network = listOf(
        ...
        MoreDestination("Loyalty", "Earn bps and tiers", Icons.Default.Star, onLoyalty),
        MoreDestination("Entity resolution", "Resolve/explain graph nodes", Icons.Default.Hub, onEntityResolution),
