          ...
          >
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2 bg-[var(--desk-canvas)] p-1 rounded-lg">
                          ...
                          {previewShowStockCounts && maxQty != null && (
                            <span className="text-[9px] font-light uppercase tracking-widest text-[var(--desk-danger)] ml-1">
                              Only {maxQty} left
                            </span>
                          )}
                          <button
            ...
            <div className="p-8 border-t border-[var(--desk-border)] bg-[var(--desk-surface-subtle)]">
              ...
              <button
                ...
                onClick={() => onCheckout()}
                className="portal-btn portal-btn--primary w-full h-14 rounded-2xl flex items-center justify-center gap-3 font-light shadow-xl transition-all hover:scale-[1.02] active:scale-95 disabled:opacity-30 disabled:hover:scale-100"
              >
                <CreditCard size={20} />
                Execute Procurement
