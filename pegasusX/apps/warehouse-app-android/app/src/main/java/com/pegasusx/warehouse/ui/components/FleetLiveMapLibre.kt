...
import com.pegasusx.warehouse.data.model.WarehouseDriverLocationWire
...
fun FleetLiveMapLibre(
    routes: List<WarehouseFleetLiveRoute>,
...
private fun WarehouseDriverLocationWire.resolvedLatitude(): Double =
    if (latitude != 0.0) latitude else lat

private fun WarehouseDriverLocationWire.resolvedLongitude(): Double =
