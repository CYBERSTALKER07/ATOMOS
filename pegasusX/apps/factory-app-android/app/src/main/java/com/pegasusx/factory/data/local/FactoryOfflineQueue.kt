...
typealias FactoryQueuedAction = QueuedMutation

/**
 * Factory offline queue on shared kit contract (§8.8).
 * Migrates legacy prefs `{id,method,endpoint,body}` on first read.
 */
object FactoryOfflineQueue {
    private const val PREFS = "factory_offline_queue_v2"
    private const val LEGACY_PREFS = "factory_offline_queue"
