...
object TokenHolder {
    ...
    var factoryId: String?
        get() = prefs.getString(KEY_FACTORY_ID, null)
        set(value) = prefs.edit().putString(KEY_FACTORY_ID, value).apply()
...
private class TokenRefreshAuthenticator(
    ...
    override fun authenticate(route: okhttp3.Route?, response: Response): Request? {
        ...
        val refreshRequest = Request.Builder()
            .url("${baseUrl}v1/auth/factory/refresh")
        ...
        return try {
            ...
            val auth = json.decodeFromString<com.pegasusx.factory.data.model.AuthResponse>(responseBody)
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideFactoryApi(retrofit: Retrofit): FactoryApi =
        retrofit.create(FactoryApi::class.java)
