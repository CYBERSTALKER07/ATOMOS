    ...
    <div className="desk-page flex flex-col gap-6">
      {isPaymentConfigured === false && (
        <div className="p-4 rounded-xl bg-[var(--desk-danger)]/10 border border-[var(--desk-danger)]/20 flex items-center justify-between">
          ...
          <Link href={"/setup/billing" as any} className="px-4 py-2 bg-[var(--desk-danger)] text-white rounded-lg text-sm font-medium hover:bg-[var(--desk-danger)]/90 transition-colors">
            Configure Now
          </Link>
        </div>
      )}
      ...
      <div className="desk-page-header !mb-0">
        <div>
          ...
          <p className="desk-page-subtitle">Live operational command center.</p>
          {error ? (
            <p className="md-typescale-body-small" style={{ color: "var(--desk-danger)", marginTop: 8 }}>
              {error}
            </p>
          ) : null}
        </div>
      ...
      <BentoGrid theme="apple">
        <BentoCard size="stat" className="p-5 flex flex-col justify-between">
          ...
          <div>
            ...
            <div
              ...
              style={{
                color:
                  metrics.revenueChangePct >= 0 ? "var(--desk-success)" : "var(--desk-danger)",
              }}
            >
          ...
          <div className="relative w-24 h-24 flex items-center justify-center my-2">
            <svg className="absolute inset-0 w-full h-full -rotate-90">
              <circle
                ...
                r="40"
                fill="none"
                stroke="var(--desk-surface-raised)"
                strokeWidth="8"
              />
              <circle
                cx="48"
        ...
        <BentoCard size="control" className="p-5 flex flex-col justify-center gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/dispatch" className="md-btn md-btn-tonal">
              Auto-dispatch preview
            </Link>
            <Link href="/orders" className="md-btn md-btn-outlined">
              Review orders
            </Link>
            <Link href="/exceptions" className="md-btn md-btn-outlined">
              Exception queue
            </Link>
          </div>
        </BentoCard>
        ...
        <BentoCard size="wide" className="p-5 flex flex-col justify-center">
          ...
          >
            <div
              ...
              style={{ width: `${vuPct}%`, background: "var(--desk-accent)" }}
            />
          </div>
        </BentoCard>
