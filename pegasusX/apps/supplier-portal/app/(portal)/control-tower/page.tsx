        ...
        {view === "network" ? (
          networkNodes.length === 0 ? (
            <div className="absolute inset-0 flex items-center justify-center text-sm text-gray-500">
              No live network telemetry for this supplier yet.
            </div>
          ) : (
            <LiveEKGNetworkGraph nodes={networkNodes} links={networkLinks} width={1200} height={800} />
          )
        ) : wsH3Data.length === 0 ? (
          <div className="absolute inset-0 flex items-center justify-center text-sm text-gray-500">
            No H3 density for this supplier yet.
          </div>
        ) : (
          <HexagonalControlTowerMap data={wsH3Data} />
        )}
