  ...
  if (shipments.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center border border-dashed border-gray-800 rounded-xl bg-[#121417]/50">
        ...
        <p className="text-sm font-semibold text-gray-400">No active shipments matching criteria</p>
        <p className="text-xs text-gray-600 mt-1">Adjust filters or select a different partner</p>
      </div>
    );
  }
