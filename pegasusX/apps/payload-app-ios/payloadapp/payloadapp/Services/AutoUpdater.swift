...
/// Legacy tree mirror of payload-app-ios distribution-aware OTA.
enum AutoUpdater {
    private static let defaultManifestURL = URL(
        string: "https://storage.googleapis.com/pegasusx-ssmr-app-updates/ios/payload/updater.json"
    )!
    ...
    private static func promptInstall(manifestURL: URL) {
        ...
        let alert = UIAlertController(
            ...
            message: "A new enterprise payload update is available.",
