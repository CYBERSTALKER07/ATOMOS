...
func RegisterRoutes(r chi.Router, d Deps) {
	...
	mountProtected := func(rr chi.Router) {
		...
		rr.Get("/v1/payloader/manifests/{manifestID}/load-ledger", d.Service.HandleLoadLedger)
		rr.Post("/v1/payloader/manifests/{manifestID}/load-ledger/scan", d.Service.HandleLoadLedgerScan)
		rr.Post("/v1/payloader/manifests/{manifestID}/load-ledger/variance/approve", d.Service.HandleLoadLedgerVarianceApprove)
