...
func RegisterRoutes(r chi.Router, d Deps) {
	...
	mountOps := func(rr chi.Router) {
		...
		rr.Post("/v1/factory/staff/{staffID}/set-password", d.Service.HandleStaffSetPassword)
		...
		rr.Get("/v1/factory/supply-requests/{id}/qc", d.Service.HandleSupplyRequestQC)
		rr.Post("/v1/factory/supply-requests/{id}/qc", d.Service.HandleSupplyRequestQC)
