...
// SpannerRepository persists warehouse events inside a Spanner outbox transaction.
// Note: Domain entities remain in-memory for scaffold endpoints, but events
// are written durably for safety and outbox relay.
