      ...
      >
        <div className="max-w-2xl space-y-6">
          ...
          <OpsSettingsForm
            ...
            setPreorderMinLeadDays={setPreorderMinLeadDays}
            preorderMaxLeadDays={preorderMaxLeadDays}
            setPreorderMaxLeadDays={setPreorderMaxLeadDays}
            orderLineMin={orderLineMin}
            setOrderLineMin={setOrderLineMin}
            ...
            setFeeTierMinor={setFeeTierMinor}
            showStockCounts={showStockCounts}
            setShowStockCounts={setShowStockCounts}
            policy={policy}
            setPolicy={setPolicy}
            enforceOrderAcceptance={enforceOrderAcceptance}
            setEnforceOrderAcceptance={setEnforceOrderAcceptance}
            scheduleIs24h={scheduleIs24h}
            setScheduleIs24h={setScheduleIs24h}
            scheduleTimezone={scheduleTimezone}
            setScheduleTimezone={setScheduleTimezone}
            weekdayOpen={weekdayOpen}
            setWeekdayOpen={setWeekdayOpen}
            weekdayClose={weekdayClose}
            setWeekdayClose={setWeekdayClose}
