...
export default function SetupWizardShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="setup-shell">
      <aside className="setup-rail" aria-label={t("warehouse_portal.setup.setup_wizard_shell.text.setup_progress")}>
        <div>
          <div className="setup-rail-brand">
            ...
            <div>
              <h2 className="setup-rail-title">{t("warehouse_portal.setup.setup_wizard_shell.text.warehouse_setup")}</h2>
        ...
        <p className="setup-rail-footer">{t("warehouse_portal.auth.text.pegasusx_and_copy_2026")}</p>
      </aside>
