...
val generatedWsModelFile = rootProject.file(
    "app/src/main/java/com/pegasus/payload/generated/contracts/PegasusWSEventEnvelope.kt"
)
...
val generateWsEventModels by tasks.registering(Exec::class) {
    ...
    commandLine(
        ...
        contractsSchemaFile.absolutePath,
        "--package",
        "com.pegasus.payload.generated.contracts",
        "--framework",
        "kotlinx",
        "--top-level",
    ...
    productFlavors {
        ...
        create("store") {
            ...
            buildConfigField(
                "String",
                "STORE_LISTING_URL",
                "\"https://play.google.com/store/apps/details?id=com.pegasus.payload\"",
            )
        }
    }
