...
/// Enterprise OTA install prompt — wired from RootView client-policy fetch.
enum AutoUpdater {
    private static let updateManifestURL = URL(string: "https://storage.googleapis.com/pegasusx-ssmr-app-updates/ios/driver/updater.json")!
