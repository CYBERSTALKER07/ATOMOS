...
export default function AdminPage() {
 ...
 <div 
 ref={notificationRef}
 className="fixed top-4 right-4 md:top-8 md:right-8 z-50 bg-[#0D0D0D] border-2 border-[#8DDC96] rounded-none p-4 md:p-6 w-80 md:w-96 max-w-[calc(100vw-2rem)]"
 >
