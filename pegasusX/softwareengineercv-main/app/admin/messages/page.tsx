...
export default function MessagesPage() {
 ...
 <div 
 ref={notificationRef}
 className="fixed top-8 right-8 z-50 bg-[#0D0D0D] border-2 border-[#A9EBF9] rounded-none p-6 w-96"
 >
 ...
 msg.read ? 'border-white/15 hover:border-white/30' : 'border-[#A9EBF9]/50 bg-black'
 }`}
 >
