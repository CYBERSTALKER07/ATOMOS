...
export const MEGA_NAV_CATEGORIES: MegaNavCategory[] = [
  ...
  },
  {
    ...
    viewAllHref: '/roles',
    links: [
      { slug: 'supplier', label: 'Supplier', description: 'Run your entire network from one place.', href: topicHref('roles', 'supplier'), flow: 'roleJourney', relatedProjectSlug: 'supplier-control-plane' },
      { slug: 'warehouse', label: 'Warehouse', description: 'Dispatch with confidence, every morning.', href: topicHref('roles', 'warehouse'), flow: 'roleJourney', relatedProjectSlug: 'warehouse-operations' },
      { slug: 'factory', label: 'Factory', description: 'Keep production and loading in sync.', href: topicHref('roles', 'factory'), flow: 'roleJourney', relatedProjectSlug: 'factory-loading' },
      { slug: 'driver', label: 'Driver', description: 'Clear routes. Simple stops. On-time delivery.', href: topicHref('roles', 'driver'), flow: 'roleJourney', relatedProjectSlug: 'driver-execution-app' },
      { slug: 'retailer', label: 'Retailer', description: 'Order, pay, and track — without phone calls.', href: topicHref('roles', 'retailer'), flow: 'roleJourney', relatedProjectSlug: 'retailer-commerce' },
      { slug: 'payload-gate', label: 'Payload / Gate', description: 'Gate control that keeps every load accountable.', href: topicHref('roles', 'payload-gate'), flow: 'roleJourney', relatedProjectSlug: 'payload-gate-control' },
      { slug: 'order-vetting', label: 'Order Vetting', description: 'Supplier approves before warehouse dispatch.', href: topicHref('roles', 'order-vetting'), flow: 'orderLifecycle', relatedProjectSlug: 'supplier-control-plane' },
      { slug: 'cash-collection', label: 'Cash Collection', description: 'Driver COD flows with treasury reconciliation.', href: topicHref('roles', 'cash-collection'), flow: 'paymentFlow', relatedProjectSlug: 'payment-integrity' },
      { slug: 'role-parity-matrix', label: 'Role Parity Matrix', description: 'Portal, mobile, and desktop for every team.', href: topicHref('roles', 'role-parity-matrix'), flow: 'appsMatrix' },
    ],
    promo: {
