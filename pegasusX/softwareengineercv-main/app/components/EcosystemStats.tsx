...
export default function EcosystemStats() {
 ...
 <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[500px] bg-white/[0.015] blur-[120px] pointer-events-none rounded-none" />

 <div className="w-full relative z-10">

 {/* Header */}
 <div className="mb-12 max-w-[1380px] mx-auto px-4 sm:px-6 md:px-8">
 <h2 id="ecosystem-stats-heading" className="text-3xl sm:text-5xl md:text-6xl font-medium tracking-tight bg-gradient-to-r from-[#A9EBF9] via-[#8DDC96] to-[#FBFF63] bg-clip-text text-transparent inline-block drop-">
 ...
 <div className="relative rounded-none sm:rounded-none border border-white/10 bg-black overflow-hidden max-h-[580px] sm:max-h-[660px] md:max-h-[720px]">
 ...
 <span className="w-3 h-3 rounded-none bg-[#FF5F56]/80 border border-[#E0443E]/50" />
 <span className="w-3 h-3 rounded-none bg-[#FFBD2E]/80 border border-[#DEA123]/50" />
 <span className="w-3 h-3 rounded-none bg-[#27C93F]/80 border border-[#1AAB29]/50" />
 </div>

 {/* Center Role Switcher Tabs */}
 <div className="hidden sm:flex items-center gap-1 bg-black p-1 rounded-none border border-white/10">
 {roleTabs.map((tab) => (
 <button
 key={tab.id}
 type="button"
 onClick={() => setActiveTab(tab.id as any)}
 className={`px-3 py-1 rounded-none text-[11px] font-mono tracking-wider transition-all duration-200 cursor-pointer ${
 activeTab === tab.id
 ...
 {/* Right Window Status */}
 <div className="flex items-center gap-2">
 <span className="w-2 h-2 rounded-none bg-white/20" />
 ...
 <div className="xl:col-span-2 rounded-none overflow-hidden stat-card group transition-all duration-500 hover:">
 ...
 <div className="bg-[#000000] border border-white/5 p-8 rounded flex flex-col relative h-[380px] md:h-full transition-colors duration-500 hover:border-white/15">
 <div className="flex justify-between items-start mb-6">
 <div className="flex items-center gap-3">
 <div className="w-8 h-8 border border-white/10 flex items-center justify-center text-white/40 bg-white/5 rounded-none">
 ...
 {/* Card 1: Circle Gauge */}
 <div className="bg-[#000000] border border-white/5 p-6 sm:p-8 rounded flex flex-col relative h-[300px] sm:h-[380px] md:h-full stat-card group transition-all duration-500 hover: hover:border-white/15">
 ...
 <svg viewBox="0 0 220 220" className="w-full max-w-[160px] sm:max-w-[220px] h-auto -rotate-90 drop-">
 ...
 {/* Card 2: Bar Chart */}
 <div className="bg-[#000000] border border-white/5 p-6 sm:p-8 rounded flex flex-col relative h-[300px] sm:h-[380px] stat-card group transition-all duration-500 hover: hover:border-white/15">
 <div className="flex justify-between items-start mb-2">
 <div className="flex items-center gap-3">
 <div className="w-8 h-8 border border-white/10 flex items-center justify-center text-white/40 bg-white/5 rounded-none">
 <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M18 6L6 18M6 6l12 12" strokeWidth="1.5" strokeLinecap="square" /></svg>
 ...
 <div className="absolute top-[35%] left-4 -translate-y-1/2 bg-white text-black text-xs font-mono px-3 py-1 rounded-none z-10">
 SLA TARGET
 </div>
 ...
 {i === 4 ? (
 <div className="w-3 h-3 rounded-none bg-gradient-to-tr from-[#FF3366] to-[#33CCFF] absolute -top-5 z-10" />
 ) : (
 <div className="w-2 h-2 rounded-none bg-white/80 absolute -top-4" />
 )}
 ...
 {/* Card 3: Speedometer */}
 <div className="bg-[#000000] border border-white/5 p-6 sm:p-8 rounded flex flex-col relative h-[300px] sm:h-[380px] xl:col-span-2 stat-card group transition-all duration-500 hover: hover:border-white/15">
 <div className="flex justify-between items-start mb-2">
 <div className="flex items-center gap-3">
 <div className="w-8 h-8 border border-white/10 flex items-center justify-center text-white/40 bg-white/5 rounded-none">
 <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M18 6L6 18M6 6l12 12" strokeWidth="1.5" strokeLinecap="square" /></svg>
 ...
 <svg viewBox="0 0 320 170" className="w-full max-w-[320px] h-auto overflow-visible drop- absolute top-4">
