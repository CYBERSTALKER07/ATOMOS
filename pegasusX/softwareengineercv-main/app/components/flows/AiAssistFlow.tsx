    ...
    <FlowShell title="AI assist with human override">
      <div className="flex flex-col items-center gap-6 md:flex-row md:justify-center">
        <div className="border border-dashed border-white/40 px-6 py-4 text-center">
          ...
          <p className="mt-2 text-sm">{language === 'ru' ? 'Грузовик B · 94% fit' : 'Truck B · 94% fit'}</p>
        </div>
        ...
        >
          <p className="font-mono text-xs uppercase opacity-60">{language === 'ru' ? 'Переопределение склада' : 'Warehouse override'}</p>
