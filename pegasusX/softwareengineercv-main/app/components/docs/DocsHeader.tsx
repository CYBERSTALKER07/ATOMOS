      ...
      <div className="max-w-[1520px] mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3 sm:space-x-4">
          <button
            ...
            className="lg:hidden p-2 -ml-2 rounded-none text-zinc-400 hover:text-white hover:bg-zinc-900 transition-colors"
          ...
          <Link href="/docs" className="flex items-center space-x-2.5 group">
            <div className="w-8 h-8 rounded-none bg-white text-black flex items-center justify-center shadow-[0_0_15px_rgba(255,255,255,0.15)] border border-white group-hover:scale-105 transition-transform">
        ...
        <div className="flex items-center space-x-3 sm:space-x-4">
          ...
          <button
            ...
            className="flex items-center justify-between w-40 sm:w-64 h-9 px-3 rounded-none bg-zinc-950 border border-white/15 text-xs text-zinc-400 hover:border-white/40 hover:text-white transition-all shadow-inner group cursor-pointer"
          >
            <div className="flex items-center space-x-2 truncate">
              <Search size={14} className="text-zinc-500 group-hover:text-white" />
              <span className="truncate">Search Docs...</span>
            </div>
            <kbd className="hidden sm:inline-flex items-center px-1.5 py-0.5 text-[10px] font-mono text-zinc-400 bg-zinc-900 border border-white/10 rounded-none">
              ⌘K
            </kbd>
          </button>

          {/* Language Switcher */}
          <div className="flex items-center rounded-none bg-zinc-950 border border-white/15 p-0.5 text-xs font-mono">
            <button
