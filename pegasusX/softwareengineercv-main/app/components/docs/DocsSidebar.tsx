    ...
    <aside className="w-full lg:w-72 xl:w-80 shrink-0 border-r border-white/10 bg-black h-full overflow-y-auto py-6 px-4 space-y-7">
      ...
      <div className="lg:hidden flex items-center justify-between pb-4 border-b border-white/10">
        ...
        <button
          ...
          className="p-1 rounded-none text-zinc-400 hover:text-white hover:bg-zinc-900"
        >
          <X className="w-5 h-5" />
        </button>
      </div>
      ...
      {/* System Status Pill */}
      <div className="px-3 py-2 rounded-none bg-zinc-950 border border-white/10 flex items-center justify-between">
        <div className="flex items-center space-x-2">
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-50 lg:hidden flex">
          <div
            ...
            onClick={onCloseMobile}
          />
          <div className="relative w-80 max-w-[85vw] bg-black border-r border-white/15 shadow-2xl h-full z-10">
            {content}
          </div>
        </div>
      )}
