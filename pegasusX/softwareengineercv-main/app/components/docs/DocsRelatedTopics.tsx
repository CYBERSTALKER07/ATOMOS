...
export default function DocsRelatedTopics({
 ...
 className="group relative p-5 rounded-none bg-black border border-white/15 hover:border-white/40 hover:bg-black transition-all duration-200 flex flex-col justify-between hover:"
 >
 <div>
 {/* Category & Badge */}
 ...
 className="flex items-center space-x-3 p-4 rounded-none border border-white/15 bg-black hover:bg-black hover:border-white/40 transition-all group"
 >
 ...
 className="flex items-center justify-end text-right space-x-3 p-4 rounded-none border border-white/15 bg-black hover:bg-black hover:border-white/40 transition-all group"
 >
 <div className="min-w-0">
 <span className="text-[10px] font-mono uppercase tracking-wider text-zinc-500 block">
 Next Article
