        ...
        <div className="border border-white/10 p-8 md:p-12 bg-[#000000] hover:bg-[#000000] transition-colors rounded-none flex flex-col justify-center min-h-[300px]">
          ...
          <ul className="space-y-4 text-white/70">
            <li className="flex items-start gap-3">
              ...
              <span className="text-base">{t('dispatch_cap_realtime')}</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-green-500 mt-1">✓</span>
              <span className="text-base">{t('dispatch_cap_predictive')}</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-green-500 mt-1">✓</span>
              <span className="text-base">{t('dispatch_cap_erp')}</span>
            </li>
          </ul>
        </div>
