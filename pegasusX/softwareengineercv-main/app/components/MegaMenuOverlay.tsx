...
function NavLink({
 ...
 {getIconForFlow(flow)}
 {badge && (
 <span className="text-[10px] font-bold px-2 py-0.5 bg-white text-black group-hover:bg-black group-hover:text-white transition-colors duration-300 rounded-none tracking-wider">
 {badge}
 </span>
 )}
 </div>
