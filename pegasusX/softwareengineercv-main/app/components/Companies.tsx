...
const CompanyCard = ({ company }: { company: Company }) => (
 ...
 <span className="px-4 py-2 bg-white hover:bg-white/90 text-black text-xs font-mono font-bold uppercase rounded-none border border-white transition-colors ">
 {company.badge}
 </span>
