...
export default function CookieBanner() {
 ...
 <div
 className={`border p-4 sm:p-6 rounded-none transition-colors duration-200 ${
 isLight
 ? 'bg-white/98 border-black/10 text-zinc-900 backdrop-blur-xl'
 : 'bg-black/98 border-white/15 text-white backdrop-blur-xl'
 }`}
 >
 ...
 <span className="font-mono text-[10px] uppercase tracking-wider font-semibold text-zinc-900 dark:text-white">
 ...
 {isGPC && (
 <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-none bg-white/10 border border-white/20 text-zinc-900 dark:text-white font-mono text-[9px] uppercase tracking-wider">
 ...
 type="button"
 onClick={acceptAll}
 className={`inline-flex items-center gap-1.5 px-4 py-2 rounded-none text-xs font-mono uppercase tracking-wider font-semibold transition-all ${
 isLight
