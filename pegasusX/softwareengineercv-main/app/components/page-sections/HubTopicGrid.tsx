...
export default function HubTopicGrid({
  ...
  return (
    <div className="mt-16 sm:mt-24 w-full flex flex-col border-t border-white/20">
      {topics.map((topic, i) => {
        ...
        return (
          <Link
            key={topic.slug}
            href={topic.href}
            className="group relative flex flex-col md:flex-row md:items-center justify-between p-6 sm:p-10 border-b border-white/20 hover:bg-white transition-colors duration-300 overflow-hidden"
          >
            ...
            <div className="relative z-10 flex flex-col max-w-3xl">
              <p className="font-mono text-xs uppercase tracking-[0.2em] text-white/40 group-hover:text-black/50 transition-colors duration-300 mb-3 sm:mb-4">
                [ {localizedTag} ]
              </p>
              <h3 className="text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tighter text-white group-hover:text-black transition-colors duration-300">
                {content.title}
              </h3>
              <p className="mt-4 text-sm sm:text-base text-white/60 group-hover:text-black/80 transition-colors duration-300 font-mono leading-relaxed max-w-2xl">
                {content.summary}
              </p>
            </div>
