...
function CapabilityCardItem({ card }: { card: CapabilityCard }) {
 ...
 <div className="relative z-10 mb-6 sm:mb-8 md:mb-10 opacity-90 group-hover:opacity-100 transition-opacity transform group-hover:-translate-y-1 duration-300 pointer-events-none drop-">
 {card.icon}
 </div>
 <h3 className="relative z-10 font-mono text-base sm:text-lg font-bold text-white mb-4 sm:mb-6 leading-snug whitespace-pre-line pointer-events-none transition-colors duration-300 group-hover:text-white drop-">
 {card.title}
 </h3>
 <p className="relative z-10 text-[13px] md:text-sm text-white/60 leading-relaxed font-sans max-w-md pointer-events-none group-hover:text-white/90 transition-colors duration-300 drop-">
 {card.description}
 </p>
 </div>
 );
