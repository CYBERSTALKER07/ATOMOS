...
export default function MasonryGrid({ images }: MasonryGridProps) {
 ...
 className={`masonry-item group block break-inside-avoid mb-6 md:mb-8 relative overflow-hidden rounded-none border-2 border-white bg-black transition-all duration-300 focus-visible:outline-none ${getColorClass(
 image.color
 )}`}
 >
 ...
 <span className="inline-block px-3 py-1 mb-3 bg-white/20 backdrop-blur-sm border border-white/30 rounded-none text-xs font-light text-white">
 {image.category}
 </span>
