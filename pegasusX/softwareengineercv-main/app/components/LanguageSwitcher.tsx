  ...
  return (
    <div className={`inline-flex items-center ${className}`}>
      ...
      >
        <span
          aria-hidden
          className={`lang-switcher__thumb pointer-events-none absolute inset-y-0.5 left-0.5 w-[calc(50%-2px)] rounded-none shadow-sm transition-transform duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] ${
            isLight
