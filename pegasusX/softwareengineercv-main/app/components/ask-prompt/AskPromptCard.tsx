...
const AskPromptCard = forwardRef<HTMLElement, AskPromptCardProps>(function AskPromptCard(
 ...
 style={style}
 className={cn(
 'ask-prompt-card relative flex flex-col justify-between rounded-none border p-5 sm:p-6',
 ...
 '',
 interactive &&
 'md:hover:border-white/25 md:hover:bg-[#171717]/92 md:hover:-translate-y-0.5 md:hover:'
 ),
 className
 )}
 >
