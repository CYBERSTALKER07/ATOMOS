...
function QueryBlock({ tokens }: { tokens: AskPromptMetric['queryLines'] }) {
 ...
 return (
 <pre className="ask-metrics-code mt-4 overflow-x-auto rounded-none border border-white/[0.08] bg-[#050505] p-4 text-[11px] sm:text-xs leading-relaxed font-mono">
 <code>
 {tokens.map((token, i) => (
...
function MetricDefinitionCard({ metric }: { metric: AskPromptMetric }) {
 return (
 <div className="ask-metrics-card rounded-none border border-white/[0.12] bg-[#000000] p-5 sm:p-6 h-full flex flex-col">
