...
export function PegasusTestimonialsSection() {
 ...
 <Link 
 href="/contact"
 className="inline-flex items-center gap-2.5 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs sm:text-sm transition-colors rounded-none shadow-emerald-950/20 group border border-emerald-500"
 >
 ...
 activeRole === role.id
 ? 'bg-emerald-500 text-black border-emerald-500 font-bold shadow-emerald-950/40'
