...
export default function Contact() {
 ...
 <div className="w-20 h-1 bg-black rounded-none mx-auto mb-6" />
 ...
 className="w-full px-4 py-3 border-2 border-black bg-white text-black focus:outline-none focus:border-black transition-colors rounded-none"
 ...
 onChange={handleChange}
 rows={6}
 className="w-full px-4 py-3 border-2 border-black bg-white text-black focus:outline-none focus:border-black transition-colors resize-none rounded-none"
 placeholder={
 ...
 <div className="success-message p-4 border-2 border-black bg-[#8DDC96] text-black rounded-none" role="status">
 ...
 {submitStatus === 'error' && (
 <div className="p-4 border-2 border-black bg-[#FE5934] text-white rounded-none" role="status">
