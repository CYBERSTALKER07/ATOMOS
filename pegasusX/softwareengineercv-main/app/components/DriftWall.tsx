...
const DriftWall = ({
 ...
 const innerClass = cx(
 'pointer-events-none absolute inset-[calc(var(--dw-gap)/2)] block overflow-hidden bg-black',
 'rounded-none opacity-[var(--dw-dim)] [transform:translateZ(0)]',
