...
function FeatureIcon({ type }: { type: string }) {
 if (type === 'lock') {
 return (
 <svg width="80" height="80" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="1" strokeLinejoin="round" aria-hidden="true" className="text-white drop-">
 {/* Lock Body */}
...
export default function PlatformFeatures() {
 ...
 `}
 >
 <div className="absolute inset-0 bg-[#000000w] bg-[size:24px_24px] opacity-20 pointer-events-none" />
