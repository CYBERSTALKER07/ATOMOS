...
export default function Footer() {
 ...
 {/* Feedback Badges */}
 {status === 'success' && (
 <div className="flex items-center gap-2 text-xs font-mono text-white bg-white/10 border border-white/20 px-3.5 py-2.5 rounded-none animate-in fade-in slide-in-from-top-1">
 ...
 {status === 'error' && (
 <div className="flex items-center gap-2 text-xs font-mono text-zinc-300 bg-white/10 border border-white/20 px-3.5 py-2.5 rounded-none animate-in fade-in slide-in-from-top-1">
