...
export default function PixelCard({
 ...
 <div
 ref={containerRef}
 className={`relative overflow-hidden grid place-items-center border-2 border-white rounded-none isolate transition-colors duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] select-none ${className}`}
