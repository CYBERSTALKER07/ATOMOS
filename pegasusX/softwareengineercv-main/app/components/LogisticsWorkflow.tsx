...
export default function LogisticsWorkflow() {
 ...
 <div className="mt-8 flex flex-wrap items-center justify-center gap-1.5 p-1.5 rounded-none bg-[#09090B] border border-[#18A049]/30 max-w-2xl">
 {TAB_OPTIONS.map((tab) => (
 <button
 key={tab.id}
 type="button"
 ...
 className={`
 px-4 py-2 rounded-none text-xs font-mono tracking-wider transition-all duration-200 cursor-pointer
 ${
 activeTab === tab.id
 ? 'bg-[#18A049] text-black font-bold '
 ...
 <div className="p-1 rounded-none bg-[#141416] border border-[#18A049]/40 ">
 <div className="px-6 py-3.5 rounded-none bg-[#09090b] border border-[#18A049]/20 flex items-center justify-center">
 ...
 <div className="workflow-badge-pill px-4 py-1.5 rounded-none bg-[#121216] border border-[#18A049]/30 text-white font-mono text-xs font-semibold whitespace-nowrap flex items-center gap-1.5">
 <span className="w-1.5 h-1.5 rounded-none bg-[#18A049] inline-block" />
 ...
 className="workflow-node-icon w-10 h-10 rounded-none flex items-center justify-center border border-white/20 transition-transform duration-200 group-hover/node:scale-115 cursor-pointer"
 >
 {node.icon}
 </div>
 {/* Tooltip */}
 <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2.5 py-1 rounded-none bg-[#18181B] border border-white/20 text-white text-[10px] font-mono whitespace-nowrap opacity-0 pointer-events-none group-hover/node:opacity-100 transition-opacity duration-150 z-30 ">
 ...
 {/* Tooltip */}
 <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-2.5 py-1 rounded-none bg-[#18181B] border border-white/20 text-white text-[10px] font-mono whitespace-nowrap opacity-0 pointer-events-none group-hover/node:opacity-100 transition-opacity duration-150 z-30 ">
 <span className="font-bold">{node.name}</span>
 <span className="text-white/50 ml-1.5">({node.sub})</span>
 </div>
 </div>
 ...
 <div className="px-4 py-2 rounded-none bg-[#121216] border border-[#18A049]/40 text-[#18A049] font-mono text-xs flex items-center gap-3 animate-fade-in ">
 <span className="w-2 h-2 rounded-none bg-[#18A049]" />
