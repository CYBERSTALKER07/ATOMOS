...
export default function TenityOrbitBentoSection({ className = '' }: TenityOrbitBentoSectionProps) {
 ...
 <div className="md:col-span-3 bg-[#CEFF00] text-black rounded-none md:rounded-l-3xl md:rounded-r-full p-8 sm:p-10 flex flex-col justify-center relative overflow-hidden transition-transform duration-300 hover:-translate-y-1 ">
 ...
 <div className="md:col-span-6 bg-[#09090B] border border-[#CEFF00]/25 rounded-none p-6 sm:p-8 flex items-center justify-around gap-4 relative overflow-hidden ">
 {/* Left Circle: Autonomous Dispatch & Optimization Portal */}
 <div className="relative group/circle cursor-pointer w-44 h-44 sm:w-56 sm:h-56 rounded-none overflow-hidden border-2 border-[#CEFF00]/60 hover:border-[#CEFF00] bg-black flex-shrink-0 transition-all duration-300">
 <Image
 src="/Unknown-8.jpg"
 ...
 <span className="px-2.5 py-0.5 rounded-none bg-black/80 border border-[#CEFF00]/60 text-[9px] font-mono font-bold tracking-widest text-[#CEFF00] uppercase backdrop-blur-sm">
 OR-TOOLS CVRP
 </span>
 </div>
 ...
 <span className="block font-title text-[#CEFF00] text-sm sm:text-base font-bold tracking-tight drop-">
 {isRu ? 'Маршрутизация' : 'Algorithmic Dispatch'}
 </span>
 <span className="block text-[10px] font-mono text-zinc-300 uppercase tracking-wider mt-0.5 drop-">
 ...
 <div className="md:col-span-3 relative rounded-none overflow-hidden min-h-[260px] md:min-h-[340px] bg-[#09090B] border border-[#CEFF00]/25 hover:border-[#CEFF00]/60 transition-colors duration-300 p-6 flex flex-col justify-between group">
 {/* Top Badge & Node Indicator */}
 <div className="flex items-center justify-between">
 <div className="flex items-center gap-2">
 <span className="w-2 h-2 rounded-none bg-[#CEFF00]" />
 ...
 <div className="w-7 h-7 rounded-none bg-[#CEFF00]/10 border border-[#CEFF00]/40 flex items-center justify-center text-[#CEFF00] group-hover:bg-[#CEFF00] group-hover:text-black transition-colors">
 ↗
 </div>
 </div>
 </div>
 ...
 <div className="md:col-span-9 bg-[#CEFF00] text-black rounded-none md:rounded-l-3xl md:rounded-r-full p-8 sm:p-12 lg:p-14 flex flex-col md:flex-row justify-between items-center relative overflow-hidden transition-transform duration-300 hover:-translate-y-1 ">
 ...
 {/* Outer Orbit Ring */}
 <div className="absolute inset-2 rounded-none border border-dashed border-black/30 animate-[spin_45s_linear_infinite]" />
 
 {/* Tactical SVG Globe Sphere */}
 <svg
 viewBox="0 0 300 300"
 className="w-full h-full text-black drop-"
 fill="none"
 >
 ...
 <div className="md:col-span-3 bg-[#09090B] border border-[#CEFF00]/30 text-white rounded-none md:rounded-l-3xl md:rounded-r-full p-8 sm:p-10 flex flex-col justify-center relative overflow-hidden transition-transform duration-300 hover:-translate-y-1 hover:border-[#CEFF00] ">
