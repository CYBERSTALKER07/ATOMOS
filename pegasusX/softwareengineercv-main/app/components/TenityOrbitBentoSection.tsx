    ...
    >
      <div className="w-full max-w-[1440px] mx-auto flex flex-col gap-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 items-stretch min-h-[340px]">
          ...
          <div className="md:col-span-3 bg-[#E2FD52] text-black rounded-3xl md:rounded-l-3xl md:rounded-r-full p-8 sm:p-10 flex flex-col justify-center relative overflow-hidden transition-transform duration-300 hover:-translate-y-1 shadow-[0_10px_40px_rgba(226,253,82,0.15)]">
          ...
          <div className="md:col-span-6 bg-[#09090B] border border-[#E2FD52]/20 rounded-3xl p-6 sm:p-8 flex items-center justify-around gap-4 relative overflow-hidden shadow-2xl">
            {/* Left Circle: Upcoming Events */}
            <div className="relative group/circle cursor-pointer w-44 h-44 sm:w-56 sm:h-56 rounded-full overflow-hidden border-2 border-[#E2FD52]/40 hover:border-[#E2FD52] shadow-[0_0_30px_rgba(226,253,82,0.15)] flex-shrink-0 transition-colors duration-300">
              <Image
                src="/tenity/mics.png"
              ...
              <span className="absolute bottom-5 left-0 right-0 text-center font-title text-[#E2FD52] text-base sm:text-lg font-semibold tracking-tight">
          ...
          <div className="md:col-span-3 relative rounded-3xl overflow-hidden min-h-[260px] md:min-h-[340px] border border-[#E2FD52]/20 hover:border-[#E2FD52]/50 transition-colors duration-300 group">
            <Image
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 items-stretch min-h-[360px]">
          ...
          <div className="md:col-span-9 bg-[#E2FD52] text-black rounded-3xl md:rounded-l-3xl md:rounded-r-full p-8 sm:p-12 lg:p-14 flex flex-col md:flex-row justify-between items-center relative overflow-hidden transition-transform duration-300 hover:-translate-y-1 shadow-[0_15px_50px_rgba(226,253,82,0.18)]">
            ...
            <div className="flex flex-col justify-between h-full z-10 w-full md:w-1/2">
              ...
              <p className="font-medium text-sm sm:text-base md:text-lg text-black/90 leading-[1.35] max-w-sm mt-8 md:mt-12">
                {isRu
          ...
          <div className="md:col-span-3 bg-[#09090B] border border-[#E2FD52]/30 text-white rounded-3xl md:rounded-l-3xl md:rounded-r-full p-8 sm:p-10 flex flex-col justify-center relative overflow-hidden transition-transform duration-300 hover:-translate-y-1 hover:border-[#E2FD52] shadow-2xl">
            <h3 className="font-title text-2xl sm:text-3xl lg:text-[34px] font-bold leading-[1.15] tracking-tight text-[#E2FD52]">
              {isRu ? (
                <>
                  Один из <br />
                  крупнейших <br />
