...
export default function UserStoriesSection() {
 ...
 <div className="relative w-14 h-14 sm:w-16 sm:h-16 rounded-none overflow-hidden border border-white/20 shrink-0 bg-[#161622] ">
 <Image
 ...
 <div className="relative w-full bg-white text-[#111116] p-6 sm:p-7 rounded-none ">
