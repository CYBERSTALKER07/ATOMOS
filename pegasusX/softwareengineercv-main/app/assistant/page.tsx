...
function AssistantWelcome({ starters }: { starters: typeof STARTERS }) {
 ...
 {/* Pegasus Logo Icon */}
 <div className="w-12 h-12 mb-4 border border-white/10 bg-black flex items-center justify-center p-2 select-none ">
 ...
 className="group relative flex flex-col justify-between p-4 bg-black hover:bg-black border border-white/10 hover:border-white/40 transition-all duration-200 text-left cursor-pointer focus:outline-none focus:border-white"
 >
 <div>
