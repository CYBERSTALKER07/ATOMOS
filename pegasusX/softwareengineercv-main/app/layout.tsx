...
export default async function RootLayout({
 ...
 <a
 href="#main-content"
 className="fixed top-4 left-4 z-[10001] bg-white text-black dark:bg-black dark:text-white px-4 py-2 rounded-none transition-transform -translate-y-20 focus:translate-y-0 font-light border-2 border-black dark:border-white"
 >
 {skipLabel}
 </a>
