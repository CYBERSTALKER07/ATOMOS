...
export default async function CookiePolicyPage() {
 ...
 <thead>
 <tr className="border-b border-black/10 dark:border-white/10 bg-zinc-50 dark:bg-black text-zinc-500 dark:text-white/50 uppercase tracking-wider text-[10px]">
