...
| Portal i18n bootstrap | **Desktop + Mobile Wired (draft)** | Desktop portals + 12 mobile apps consume generated en/ru/uz (~4045 keys). Draft translations — **not** product-linguistic Done |
...
| Desktop full uz/ru i18n | **Wired (draft)** |
| Mobile full uz/ru i18n | **Wired (draft) + interpolations** | Named `{ph}` catalogs → `%n$s`/`%@`; `L10n.format` / `stringResource(_, args)`; residual: ICU plurals / embedded-copy (~37) + pure values |
