...
2. `PX5-A2` Telemetry and live tracking integrity
  ...
  Delta 2026-07-07: Tranche 22 landed as full mobile mock data elimination — all 11 native iOS and Android apps (driver, factory, payload, supplier, warehouse, retailer) have been scrubbed of static mock data and local mock protocols (e.g., `MockURLProtocol`, `MockH3`, `Mission.mockMissions`). All mobile clients are now strictly wired to real backend API endpoints and the Spanner/Kafka production environment.
