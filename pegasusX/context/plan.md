...
**Planning brain (90-day track):** [`plan_90.md`](plan_90.md) — o9-inspired MEIO, actionable control tower, demand baseline, scenario sandbox, and EKG-lite for pegasusX (single-supplier), with pegasus multi-supplier handoff contracts. **PX91 extension (gates, ingest, confidence UI, promo sandbox):** [`PlanDigitalBrain.md`](PlanDigitalBrain.md). Execution anchors remain in this file; PX90/PX91 anchors live in `plan_90.md` and `PlanDigitalBrain.md`.
