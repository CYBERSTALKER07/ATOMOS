 ...
 * Shared across pegasusX native Android apps (promoted from retailer-app-android).
 */
object PegasusMotionTokens {
...
/** Legacy motion aliases used by driver and retailer shells. */
object PegasusAnim {
    val snappy = PegasusMotionTokens.springFastSpatial
    val bouncy = PegasusMotionTokens.springDefaultSpatial
    val micro = PegasusMotionTokens.springFastSpatial
    val settle = PegasusMotionTokens.springSlowSpatial
